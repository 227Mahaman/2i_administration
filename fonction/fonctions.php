<?php
	...
	function Y_M_D($date){
		return htmlspecialchars(date("Y-m-d", strtotime($date)));
	}
	...
	function nouveau_alert($type_alert, $contenu_alert){
	...
	function verifier_droit_page(){
		...
		if(in_array($page_courante, $page_autorisees)){
			...
			session_start();
			nouveau_alert('danger','Vous n\'avez pas accés à cette page.');
